...
DOCKER_COMPOSE_FILE=https://github.com/lightningcn/ln-node/raw/master/arm64v8/docker-compose_bitcoin_lnd_rtl.yml
...
export LIGHTNING_ALIAS=arm64v8.lightningcn.com
